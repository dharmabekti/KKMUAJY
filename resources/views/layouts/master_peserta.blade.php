          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                ...
                <h2>{{ Auth::User()->first_name}} | Peserta PKM</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="{{ route('pengusul.index') }}"><i class="fa fa-users"></i> Identitas Pengusul</a></li>
                  <li><a href="{{ route('pengusul.simbelmawa') }}"><i class="fa fa-glass"></i> Simbelmawa</a></li>
                </ul>
              </div>
            ...
            <div class="sidebar-footer hidden-small">
              <a href="{{ route('pengusul.profil') }}" data-toggle="tooltip" data-placement="top" title="Profil">
                <span class="glyphicon glyphicon-user" aria-hidden="true"></span>
              </a>
              <a href="{{ route('berkas.index') }}" data-toggle="tooltip" data-placement="top" title="Berkas PKM">
